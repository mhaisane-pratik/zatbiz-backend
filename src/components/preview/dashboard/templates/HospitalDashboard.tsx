...
export default function HospitalDashboard({
  ...
  return (
    <div className={`flex flex-1 min-h-screen ${isDarkMode ? 'dark bg-slate-950 text-slate-100' : 'bg-slate-50 text-slate-800'}`}>
          ...
          <nav className="space-y-0.5 max-h-[70vh] overflow-y-auto pr-1">
            ...
            {activeRole === 'admin' && (
              <>
                ...
                <button onClick={() => setActiveTab('settings')} className={`w-full flex items-center gap-3 px-4 py-2.5 text-xs font-bold rounded-xl transition text-left cursor-pointer border-none bg-transparent ${activeTab === 'settings' ? `${theme.activeTabBg} ${theme.accentText}` : 'text-slate-500 dark:text-slate-400 hover:text-slate-900 hover:bg-slate-50 dark:hover:bg-slate-800'}`}>⚙️ Settings</button>
            ...
            {activeRole === 'doctor' && (
              <>
                ...
                <button onClick={() => setActiveTab('doctor_schedule')} className={`w-full flex items-center gap-3 px-4 py-2.5 text-xs font-bold rounded-xl transition text-left cursor-pointer border-none bg-transparent ${activeTab === 'doctor_schedule' ? `${theme.activeTabBg} ${theme.accentText}` : 'text-slate-500 dark:text-slate-400 hover:text-slate-900 hover:bg-slate-50'}`}>📅 Today's Appointments</button>
                ...
                <button onClick={() => setActiveTab('doctor_patients')} className={`w-full flex items-center gap-3 px-4 py-2.5 text-xs font-bold rounded-xl transition text-left cursor-pointer border-none bg-transparent ${activeTab === 'doctor_patients' ? `${theme.activeTabBg} ${theme.accentText}` : 'text-slate-500 dark:text-slate-400 hover:text-slate-900 hover:bg-slate-50'}`}>👥 My Patients</button>
                <button onClick={() => setActiveTab('doctor_consults')} className={`w-full flex items-center gap-3 px-4 py-2.5 text-xs font-bold rounded-xl transition text-left cursor-pointer border-none bg-transparent ${activeTab === 'doctor_consults' ? `${theme.activeTabBg} ${theme.accentText}` : 'text-slate-500 dark:text-slate-400 hover:text-slate-900 hover:bg-slate-50'}`}>🩺 Consultation</button>
                ...
                <button onClick={() => setActiveTab('doctor_lab_requests')} className={`w-full flex items-center gap-3 px-4 py-2.5 text-xs font-bold rounded-xl transition text-left cursor-pointer border-none bg-transparent ${activeTab === 'doctor_lab_requests' ? `${theme.activeTabBg} ${theme.accentText}` : 'text-slate-500 dark:text-slate-400 hover:text-slate-900 hover:bg-slate-50'}`}>🧪 Lab Test Requests</button>
                ...
                <button onClick={() => setActiveTab('doctor_treatment_plans')} className={`w-full flex items-center gap-3 px-4 py-2.5 text-xs font-bold rounded-xl transition text-left cursor-pointer border-none bg-transparent ${activeTab === 'doctor_treatment_plans' ? `${theme.activeTabBg} ${theme.accentText}` : 'text-slate-500 dark:text-slate-400 hover:text-slate-900 hover:bg-slate-50'}`}>📋 Treatment Plans</button>
                <button onClick={() => setActiveTab('doctor_followups')} className={`w-full flex items-center gap-3 px-4 py-2.5 text-xs font-bold rounded-xl transition text-left cursor-pointer border-none bg-transparent ${activeTab === 'doctor_followups' ? `${theme.activeTabBg} ${theme.accentText}` : 'text-slate-500 dark:text-slate-400 hover:text-slate-900 hover:bg-slate-50'}`}>🔄 Follow-ups</button>
                <button onClick={() => setActiveTab('doctor_schedule_mgmt')} className={`w-full flex items-center gap-3 px-4 py-2.5 text-xs font-bold rounded-xl transition text-left cursor-pointer border-none bg-transparent ${activeTab === 'doctor_schedule_mgmt' ? `${theme.activeTabBg} ${theme.accentText}` : 'text-slate-500 dark:text-slate-400 hover:text-slate-900 hover:bg-slate-50'}`}>📅 My Schedule</button>
                <button onClick={() => setActiveTab('doctor_messages')} className={`w-full flex items-center gap-3 px-4 py-2.5 text-xs font-bold rounded-xl transition text-left cursor-pointer border-none bg-transparent ${activeTab === 'doctor_messages' ? `${theme.activeTabBg} ${theme.accentText}` : 'text-slate-500 dark:text-slate-400 hover:text-slate-900 hover:bg-slate-50'}`}>💬 Messages</button>
                <button onClick={() => setActiveTab('doctor_reports')} className={`w-full flex items-center gap-3 px-4 py-2.5 text-xs font-bold rounded-xl transition text-left cursor-pointer border-none bg-transparent ${activeTab === 'doctor_reports' ? `${theme.activeTabBg} ${theme.accentText}` : 'text-slate-500 dark:text-slate-400 hover:text-slate-900 hover:bg-slate-50'}`}>📊 Reports & Analytics</button>
                <button onClick={() => setActiveTab('doctor_reviews')} className={`w-full flex items-center gap-3 px-4 py-2.5 text-xs font-bold rounded-xl transition text-left cursor-pointer border-none bg-transparent ${activeTab === 'doctor_reviews' ? `${theme.activeTabBg} ${theme.accentText}` : 'text-slate-500 dark:text-slate-400 hover:text-slate-900 hover:bg-slate-50'}`}>⭐ Patient Reviews</button>
                <button onClick={() => setActiveTab('doctor_profile')} className={`w-full flex items-center gap-3 px-4 py-2.5 text-xs font-bold rounded-xl transition text-left cursor-pointer border-none bg-transparent ${activeTab === 'doctor_profile' ? `${theme.activeTabBg} ${theme.accentText}` : 'text-slate-500 dark:text-slate-400 hover:text-slate-900 hover:bg-slate-50'}`}>👤 My Profile</button>
                <button onClick={() => setActiveTab('doctor_notifications')} className={`w-full flex items-center gap-3 px-4 py-2.5 text-xs font-bold rounded-xl transition text-left cursor-pointer border-none bg-transparent ${activeTab === 'doctor_notifications' ? `${theme.activeTabBg} ${theme.accentText}` : 'text-slate-500 dark:text-slate-400 hover:text-slate-900 hover:bg-slate-50'}`}>🔔 Notifications</button>
                <button onClick={() => setActiveTab('doctor_settings')} className={`w-full flex items-center gap-3 px-4 py-2.5 text-xs font-bold rounded-xl transition text-left cursor-pointer border-none bg-transparent ${activeTab === 'doctor_settings' ? `${theme.activeTabBg} ${theme.accentText}` : 'text-slate-500 dark:text-slate-400 hover:text-slate-900 hover:bg-slate-50'}`}>⚙️ Settings</button>
              </>
            )}
            ...
            {activeRole === 'reception' && (
              <>
                <button onClick={() => setActiveTab('reception_queue')} className={`w-full flex items-center gap-3 px-4 py-2.5 text-xs font-bold rounded-xl transition text-left cursor-pointer border-none bg-transparent ${activeTab === 'reception_queue' ? `${theme.activeTabBg} ${theme.accentText}` : 'text-slate-500 dark:text-slate-400 hover:text-slate-900 hover:bg-slate-50'}`}>🚶 Live Queue & Walk-ins</button>
                <button onClick={() => setActiveTab('reception_register')} className={`w-full flex items-center gap-3 px-4 py-2.5 text-xs font-bold rounded-xl transition text-left cursor-pointer border-none bg-transparent ${activeTab === 'reception_register' ? `${theme.activeTabBg} ${theme.accentText}` : 'text-slate-500 dark:text-slate-400 hover:text-slate-900 hover:bg-slate-50'}`}>👤 Patient Registration</button>
            ...
            {activeRole === 'nurse' && (
              <>
                <button onClick={() => setActiveTab('nurse_monitoring')} className={`w-full flex items-center gap-3 px-4 py-2.5 text-xs font-bold rounded-xl transition text-left cursor-pointer border-none bg-transparent ${activeTab === 'nurse_monitoring' ? `${theme.activeTabBg} ${theme.accentText}` : 'text-slate-500 dark:text-slate-400 hover:text-slate-900 hover:bg-slate-50'}`}>🏥 Ward Monitoring</button>
                <button onClick={() => setActiveTab('nurse_vitals')} className={`w-full flex items-center gap-3 px-4 py-2.5 text-xs font-bold rounded-xl transition text-left cursor-pointer border-none bg-transparent ${activeTab === 'nurse_vitals' ? `${theme.activeTabBg} ${theme.accentText}` : 'text-slate-500 dark:text-slate-400 hover:text-slate-900 hover:bg-slate-50'}`}>🩺 Log Vitals</button>
              </>
            )}
            ...
            {activeRole === 'lab' && (
              <>
                <button onClick={() => setActiveTab('lab_queue')} className={`w-full flex items-center gap-3 px-4 py-2.5 text-xs font-bold rounded-xl transition text-left cursor-pointer border-none bg-transparent ${activeTab === 'lab_queue' ? `${theme.activeTabBg} ${theme.accentText}` : 'text-slate-500 dark:text-slate-400 hover:text-slate-900 hover:bg-slate-50'}`}>🧪 Lab Samples Queue</button>
                <button onClick={() => setActiveTab('lab_reports')} className={`w-full flex items-center gap-3 px-4 py-2.5 text-xs font-bold rounded-xl transition text-left cursor-pointer border-none bg-transparent ${activeTab === 'lab_reports' ? `${theme.activeTabBg} ${theme.accentText}` : 'text-slate-500 dark:text-slate-400 hover:text-slate-900 hover:bg-slate-50'}`}>📋 Diagnostics Archives</button>
              </>
            )}
            ...
            {activeRole === 'pharmacy' && (
              <>
                <button onClick={() => setActiveTab('pharmacy_prescriptions')} className={`w-full flex items-center gap-3 px-4 py-2.5 text-xs font-bold rounded-xl transition text-left cursor-pointer border-none bg-transparent ${activeTab === 'pharmacy_prescriptions' ? `${theme.activeTabBg} ${theme.accentText}` : 'text-slate-500 dark:text-slate-400 hover:text-slate-900 hover:bg-slate-50'}`}>📋 Active Prescriptions</button>
        ...
        <div className="max-w-6xl mx-auto space-y-6">
          <header className={`flex justify-between items-center pb-6 border-b ${isDarkMode ? 'border-slate-800' : 'border-slate-200'}`}>
            ...
            <div className={`text-[10px] border rounded-lg px-3 py-1.5 font-extrabold shadow-sm flex items-center gap-2 select-none ${
              isDarkMode ? 'bg-slate-900 border-slate-800 text-slate-350' : 'bg-white border-slate-200 text-slate-500'
            }`}>
                    ...
                    <div className="divide-y divide-slate-100 dark:divide-slate-800">
                      {clinicalQueue.slice(0, 3).map((q) => (
                        <div key={q.id} className="py-2 flex justify-between items-center text-xs">
                          <div>
                            <strong className="text-slate-800 dark:text-slate-200">{q.patientName}</strong>
              ...
              <div className={`p-6 border rounded-2xl shadow-sm ${isDarkMode ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-200'}`}>
                ...
                <form onSubmit={handleDocSubmit} className="space-y-4">
                  ...
                  <div className="flex justify-end gap-2">
                    ...
                    <button
                      type="submit"
                      className="px-6 py-2 bg-slate-900 hover:bg-black dark:bg-slate-105 dark:hover:bg-slate-200 dark:text-slate-950 text-white font-bold rounded-xl transition shadow border-none cursor-pointer"
                    >
                    ...
                    products.map((doc) => (
                      <div key={doc.id} className="border border-slate-200 dark:border-slate-800 rounded-2xl p-5 flex items-start gap-4 hover:shadow-md transition">
                        ...
                        <div className="space-y-1 min-w-0 text-left">
                          ...
                          <p className="font-bold text-slate-800 dark:text-slate-300 text-[10px] mt-2">Consult fee: ₹{doc.price}</p>
                  ...
                  <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                    {reservations.map((res) => (
                      <tr key={res.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-900/50">
                        ...
                        <td className="p-4">
                          <span className="font-bold text-slate-800 dark:text-slate-300 block">{res.bookingDate}</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start text-xs text-left">
              ...
              <div className={`p-6 border rounded-2xl shadow-sm space-y-4 ${
                ...
                <form onSubmit={handleDoctorConsultSubmit} className="space-y-4">
                  ...
                  <div>
                    <label className="block text-[10px] font-bold text-slate-500 uppercase mb-2">Prescription & Medication Dosage</label>
                    <textarea
                      rows={3}
                  ...
                  <div className="p-3 bg-slate-50 dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 space-y-2">
                    ...
                    {newConsultNeedLabTest && (
                      <input
                        ...
                        className="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg px-2.5 py-1.5 text-[11px] outline-none"
                      />
                    )}
                  </div>
                  ...
                  medicalRecords.map((rec) => (
                    <div key={rec.id} className={`p-6 border rounded-2xl shadow-sm space-y-4 ${
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="bg-amber-50/20 dark:bg-amber-950/10 border border-amber-100/50 dark:border-amber-900/30 p-4 rounded-xl text-left">
                ...
                <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                  {billingInvoices.map((inv) => (
                    <tr key={inv.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-900/50">
                      ...
                      <td className="p-4 font-bold text-slate-700 dark:text-slate-350">{inv.patientEmail}</td>
                      <td className="p-4 font-semibold text-slate-550">{inv.date}</td>
                      <td className="p-4 text-[10px] text-slate-450 leading-relaxed font-semibold">
                        Doctor Consult: ₹{inv.doctorFee} <br />
                        Pharmacy/Meds: ₹{inv.pharmacyCharges} <br />
                        Diagnostics: ₹{inv.labCharges}
                      </td>
                      <td className="p-4 font-black text-slate-900 dark:text-white">₹{inv.total}</td>
                      <td className="p-4">
                        <span className={`px-2 py-0.5 rounded text-[8px] font-black uppercase border ${
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-slate-50 dark:bg-slate-850 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-2.5 text-xs outline-none cursor-pointer font-bold"
                    >
          ...
          {activeTab === 'doctor_consults' && activeRole === 'doctor' && (
            <div className={`p-6 border rounded-2xl shadow-sm space-y-4 text-xs text-left ${
              ...
              <h3 className="text-xs font-black uppercase">Physician Consultation Desk</h3>
              <p className="text-slate-450 font-bold uppercase">Input patient diagnostics details and record prescriptions directly to their file</p>
              ...
              <form onSubmit={handleDoctorConsultSubmit} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      value={newConsultEmail}
                      onChange={(e) => setNewConsultEmail(e.target.value)}
                      className="w-full bg-slate-50 dark:bg-slate-850 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-2 text-xs outline-none focus:bg-white focus:border-indigo-600 transition"
                    />
                  </div>
                  <div>
                ...
                <div className="flex justify-end pt-2">
                  <button type="submit" className="px-6 py-3 bg-slate-900 hover:bg-black dark:bg-white dark:text-slate-950 text-white rounded-xl text-xs font-black uppercase tracking-widest border-none cursor-pointer">
          ...
          {activeTab === 'reception_queue' && activeRole === 'reception' && (
            <div className="space-y-6 text-xs text-left">
              ...
              <div className="bg-rose-50 border border-rose-100 p-6 rounded-3xl text-left space-y-3">
                ...
                <p className="text-rose-600 leading-relaxed font-semibold">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-xs text-left">
              ...
              <div className={`p-6 border rounded-2xl shadow-sm space-y-4 ${
                ...
                <div className="space-y-3 max-h-[400px] overflow-y-auto">
                  {vitalsLogs.map((vl) => (
                    <div key={vl.id} className="p-3 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl space-y-1.5 text-left">
                      <div className="flex justify-between text-[10px]">
                        <strong className="text-slate-800 dark:text-slate-300">{vl.patientEmail}</strong>
              ...
              <form onSubmit={handleVitalsSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 dark:bg-slate-850 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-2.5 text-xs outline-none focus:bg-white focus:border-indigo-650 transition"
                  />
                </div>

                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-[10px] font-bold text-slate-500 uppercase mb-2">Blood Pressure (mmHg)</label>
                    <input
                      type="text"
                      required
                      placeholder="120/80"
                      ...
                      className="w-full bg-slate-50 dark:bg-slate-850 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-2.5 text-xs outline-none"
                    />
                  </div>
                  <div>
                    <label className="block text-[10px] font-bold text-slate-500 uppercase mb-2">Pulse Rate (bpm)</label>
                    <input
                      type="number"
                      required
                      value={vitalPulse}
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-[10px] font-bold text-slate-500 uppercase mb-2">Oxygen Level SpO2 (%)</label>
                    <input
                      type="number"
                      required
                      value={vitalSpO2}
              ...
              {labReportId && (
                <div className={`p-6 border rounded-2xl shadow-sm space-y-4 ${
                  ...
                  <form onSubmit={handleLabReportUpdate} className="space-y-4">
                    <div>
                      <label className="block text-[10px] font-bold text-slate-500 uppercase mb-2">Test Parameters / Results Values</label>
                      <input
                        type="text"
                        required
                        value={labTestValue}
                        onChange={(e) => setLabTestValue(e.target.value)}
                        className="w-full bg-slate-50 dark:bg-slate-850 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-2 text-xs outline-none"
                      />
                    </div>
                    <div>
                      <label className="block text-[10px] font-bold text-slate-500 uppercase mb-2">Pathologist Remarks</label>
                      <input
                        type="text"
                        value={labRemarks}
                ...
                {activeLabList.filter(l => l.status === 'Completed').length === 0 ? (
                  ...
                  activeLabList.filter(l => l.status === 'Completed').map((lab) => (
                    <div key={lab.id} className="p-4 border border-slate-200 dark:border-slate-800 rounded-2xl text-left space-y-2">
                      ...
                      <p className="text-[10px] text-slate-450 font-bold uppercase">Patient: {lab.patientEmail}</p>
                      <div className="p-3 bg-slate-50 dark:bg-slate-950 border border-slate-200 rounded-xl space-y-1 font-semibold leading-relaxed">
                    ...
                    medicalRecords.map((rec) => (
                      <div key={rec.id} className="py-4 flex justify-between items-start gap-4">
                        <div className="space-y-1">
                          ...
                          <div className="p-3 bg-slate-50 dark:bg-slate-950 rounded-xl border border-slate-100 mt-2 font-mono whitespace-pre-line text-slate-700 dark:text-slate-350">
                            {rec.prescription}
                          </div>
                        </div>
                        <button
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 text-xs text-left">
              ...
              <div className={`p-6 border rounded-2xl shadow-sm space-y-4 ${
                ...
                <form onSubmit={handleMedicineSubmit} className="space-y-3">
                  ...
                  <button type="submit" className="w-full py-2 bg-slate-905 hover:bg-black text-white font-bold rounded-xl uppercase tracking-wider transition border-none cursor-pointer">
                    Register Medicine
                  </button>
                </form>
              </div>
                  ...
                  <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                    {medicineInventory.map((med) => (
                      <tr key={med.id} className="hover:bg-slate-50/50">
                        ...
                        <td className="p-3 font-mono font-semibold text-slate-500">{med.location}</td>
                  ...
                  products.map((doc) => (
                    <div key={doc.id} className={`border rounded-3xl overflow-hidden shadow-sm flex flex-col justify-between group ${
                      ...
                      <div className="h-40 bg-slate-100 relative overflow-hidden flex items-center justify-center">
                        ...
                        <span className="absolute bottom-3 right-3 bg-white/90 dark:bg-slate-900/90 backdrop-blur-sm px-2.5 py-1 rounded-full text-[9px] font-black text-slate-900 dark:text-white border border-slate-100 dark:border-slate-800 shadow-sm">
                      ...
                      <div className="p-5 space-y-3 flex-1 flex flex-col justify-between text-left">
                        <div>
                          ...
                          <h4 className="font-extrabold text-slate-900 dark:text-white text-xs uppercase tracking-wider leading-tight">{doc.name}</h4>
                          <p className="text-[10px] font-semibold text-slate-450 mt-1 leading-relaxed">{doc.description}</p>
                        </div>
                        <button
                          onClick={() => {
                ...
                <form onSubmit={handleBookAppointment} className="space-y-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-slate-50 dark:bg-slate-850 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-2.5 text-xs outline-none focus:bg-white focus:border-indigo-650 transition cursor-pointer font-bold"
                    >
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="block text-[10px] font-bold text-slate-500 uppercase mb-2">Preferred Date</label>
                      <input
                        type="date"
                        required
                    ...
                    <div>
                      <label className="block text-[10px] font-bold text-slate-500 uppercase mb-2">Time Slot</label>
                      <select
                  ...
                  <div>
                    <label className="block text-[10px] font-bold text-slate-500 uppercase mb-2">Chief Complaint / Symptoms</label>
                    <textarea
                      rows={3}
                      ...
                      className="w-full bg-slate-50 dark:bg-slate-850 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-2.5 text-xs outline-none focus:bg-white resize-none"
                    />
                  </div>
            ...
            <div className="space-y-4 text-xs text-left">
              ...
              {vitalsLogs.filter(v => v.patientEmail === clientEmail).length > 0 && (
                <div className={`p-6 border rounded-2xl shadow-sm space-y-4 ${
                  ...
                  <span className="text-[8px] bg-indigo-50 dark:bg-indigo-950 text-indigo-700 dark:text-indigo-400 px-2 py-0.5 rounded font-black uppercase tracking-widest">Logged Vitals History</span>
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              {activeLabList.filter(l => l.patientEmail === clientEmail).length > 0 && (
                <div className={`p-6 border rounded-2xl shadow-sm space-y-4 ${
                  ...
                  <span className="text-[8px] bg-emerald-50 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-400 px-2 py-0.5 rounded font-black uppercase tracking-widest">Lab Diagnostics Reports</span>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {activeLabList.filter(l => l.patientEmail === clientEmail).map((l) => (
                      <div key={l.id} className="p-4 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-850 rounded-xl leading-relaxed">
                        <div className="flex justify-between items-center">
                          <strong className="text-slate-900 dark:text-white uppercase text-[10px]">{l.testName}</strong>
                        ...
                        {l.status === 'Completed' && (
                          <div className="mt-2 text-[10px] text-slate-650 space-y-1">
              ...
              {medicalRecords.filter(r => r.patientEmail === clientEmail).length === 0 ? (
                ...
                medicalRecords.filter(r => r.patientEmail === clientEmail).map((rec) => (
                  <div key={rec.id} className={`p-6 border rounded-2xl shadow-sm space-y-4 ${
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="bg-slate-50 dark:bg-slate-950 border border-slate-200/50 dark:border-slate-850 p-4 rounded-xl text-left">
                        <p className="text-[9px] text-slate-400 font-bold uppercase tracking-wider mb-2">💊 Digital Prescription</p>
                        <p className="font-mono text-[10px] whitespace-pre-line text-slate-705 dark:text-slate-350">{rec.prescription || 'No medicines.'}</p>
                      </div>
                      <div className="bg-amber-50/25 dark:bg-amber-950/10 border border-amber-100/50 dark:border-amber-900/30 p-4 rounded-xl text-left">
                        <p className="text-[9px] text-slate-400 font-bold uppercase tracking-wider mb-2">❤️ Clinical Advice & Notes</p>
                        <p className="italic text-[10px] text-slate-600 dark:text-slate-400">{rec.notes}</p>
                      </div>
                    </div>
                  </div>
          ...
          {activeTab === 'doctor_dashboard' && activeRole === 'doctor' && (
            <div className="space-y-6 text-xs text-left">
              ...
              <div className={`p-6 rounded-3xl border shadow-sm flex justify-between items-center relative overflow-hidden ${
                isDarkMode ? 'bg-gradient-to-br from-slate-900 via-slate-900 to-emerald-950/20 border-slate-800' : 'bg-gradient-to-br from-white via-white to-emerald-50/20 border-slate-200'
              }`}>
                <div className="space-y-2 z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className={`p-5 rounded-2xl border shadow-sm bg-rose-500/10 border-rose-500/30`}>
                  ...
                  <h3 className="text-sm font-black mt-2 text-rose-600 dark:text-rose-400">Critical: 0 Active</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className={`p-5 rounded-2xl border shadow-sm ${isDarkMode ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-200'}`}>
                  ...
                  {clinicalQueue.filter(q => q.status === 'Waiting').length > 0 ? (
                    ...
                    <div className="p-4 text-center text-slate-450 font-bold uppercase">No patient waiting.</div>
                  )}
                </div>
                ...
                <div className={`p-5 rounded-2xl border shadow-sm ${isDarkMode ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-200'}`}>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <button onClick={() => setActiveTab('doctor_schedule')} className="p-2 border border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg text-slate-600 dark:text-slate-350 bg-white dark:bg-slate-950 font-bold text-center border-solid cursor-pointer">📅 Schedule</button>
                    <button onClick={() => setActiveTab('doctor_consults')} className="p-2 border border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg text-slate-600 dark:text-slate-350 bg-white dark:bg-slate-950 font-bold text-center border-solid cursor-pointer">🩺 Consults</button>
                    <button onClick={() => setActiveTab('doctor_prescriptions')} className="p-2 border border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg text-slate-600 dark:text-slate-355 bg-white dark:bg-slate-950 font-bold text-center border-solid cursor-pointer">💊 Prescribe</button>
                    <button onClick={() => setActiveTab('doctor_lab_requests')} className="p-2 border border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg text-slate-600 dark:text-slate-355 bg-white dark:bg-slate-950 font-bold text-center border-solid cursor-pointer">🧪 Request Lab</button>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    {medicineInventory.map((med) => (
                      <div key={med.id} className="p-4 border rounded-xl bg-slate-50/50 dark:bg-slate-900/50 leading-relaxed space-y-1">
                        <strong className="text-slate-800 dark:text-slate-200 block text-[10px]">{med.name}</strong>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {[
                      ...
                      <div key={nurse.name} className="p-4 border rounded-xl bg-slate-50/50 dark:bg-slate-900/50 leading-relaxed">
                        <strong className="text-[10px] text-slate-800 dark:text-slate-200 block">{nurse.name}</strong>
