  ...
  return (
    <main className="min-h-screen bg-slate-50 flex items-stretch text-slate-800 font-sans relative overflow-hidden">
      ...
      >
        ...
        <p className="text-[10px] text-slate-500 font-semibold uppercase tracking-wider z-10">
              ...
              <div className="flex items-center justify-between pt-1">
                <label className="flex items-center gap-2 text-xs font-bold text-slate-600 select-none cursor-pointer">
                  <input
                    ...
                    className="rounded border-slate-300 text-teal-650 focus:ring-teal-505/20 h-4 w-4"
                  />
      ...
      {showForgotModal && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white border border-slate-200 rounded-3xl p-6 max-w-sm w-full shadow-2xl text-left space-y-4">
            <div>
              <h3 className="text-sm font-black text-slate-900 uppercase tracking-wide">Recover Access Code</h3>
            ...
            <form onSubmit={handleForgotSubmit} className="space-y-3">
              <input
                ...
                className={`w-full rounded-xl border bg-slate-50/20 px-4 py-2 text-xs text-slate-900 outline-none transition ${accents.border}`}
              />
